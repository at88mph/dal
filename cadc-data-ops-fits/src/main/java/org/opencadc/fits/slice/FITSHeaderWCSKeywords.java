...
public class FITSHeaderWCSKeywords implements WCSKeywords {
    ...
    /**
     * Obtain the time (1-based) axis from the current header.  Return -1 if none found that match the Polarization
     * types.
     *
     * @return int axis, or -1 if no polarization axis present.
     */
    ...
    /**
     * Obtain the time (1-based) axis from the given header.  Return -1 if none found that match the Polarization types.
     *
     * @return integer axis, or -1 if not found.
     */
